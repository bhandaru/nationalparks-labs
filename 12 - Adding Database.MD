...
___  
```
http://nationalparks-git-userXY.apps.cluster-dfw-a75a.dfw-a75a.example.opentlc.com/ws/data/all
```
...
___
```
http://nationalparks-git-userXY.apps.cluster-dfw-a75a.dfw-a75a.example.opentlc.com/ws/data/load
```
