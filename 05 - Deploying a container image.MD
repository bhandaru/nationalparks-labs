...
https://master.osevg.openshiftworkshop.com
	In the following steps, replace userXY with the project provided to you.

Find your userXY project and click it. On the next page, click "Add to Project" and a drop down menu will appear. There are several options, but we are only concerned with "Deploy Image". Click "Deploy Image" in the "Add to Project" drop down.
Add to Project
